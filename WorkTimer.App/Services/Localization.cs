...
public static class Localization
{
 ...
 "MinimizeToTray" => "Minimize to tray on minimize",
 "MinimizeToTrayOnClose" => "Minimize to tray on close",
 "TipMinimizeToTray" => "When enabled, minimizing the window will hide it to the system tray instead of the taskbar.",
 "TipMinimizeToTrayOnClose" => "When enabled, closing the window will hide it to the system tray instead of exiting the application.",
 "StartWithWindows" => "Start with Windows",
 "TipStartWithWindows" => "When enabled, the application will automatically start when you log in to Windows.",
 "Language" => "Language:",
 "LanguageCs" => "Èeština",
 "LanguageEn" => "English",
